<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AddMasterSales.aspx.cs" Inherits="PrivateICO.AddMasterSales" %>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="drpSalesGuy" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="drpSalesGuy_SelectedIndexChanged"></asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox runat="server" ID="txtDate" CssClass="form-control" required placeholder="Choose Date"></asp:TextBox>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#ctl00_ContentPlaceHolder1_txtDaySales').change(function () {
                ...
                else if (currentMonthlySale > 9500) {
            ...
            $('#ctl00_ContentPlaceHolder1_txtDaySales').blur(function () {
                var daySaleAmount = $('#ctl00_ContentPlaceHolder1_txtDaySales').val();
                var refunds = $('#ctl00_ContentPlaceHolder1_txtRefunds').val();
            ...
            $('#ctl00_ContentPlaceHolder1_txtRefunds').blur(function () {
                var daySaleAmount = $('#ctl00_ContentPlaceHolder1_txtDaySales').val();
                var refunds = $('#ctl00_ContentPlaceHolder1_txtRefunds').val();
                if (isNaN(daySaleAmount) || daySaleAmount == "") {
                    daySaleAmount = "0.00";
            ...
            $('#ctl00_ContentPlaceHolder1_txtBonus').blur(function () {
                var dayBonus = parseFloat($('#ctl00_ContentPlaceHolder1_txtBonus').val());
                $('#ctl00_ContentPlaceHolder1_txtTotalCashBonus').val(parseFloat(totalBonus) + dayBonus);
                calculateQBPay();
            });

            $('#ctl00_ContentPlaceHolder1_txtCommision').blur(function () {
                calculateQBPay();
            });
            $('#ctl00_ContentPlaceHolder1_txtTotalCashBonus').blur(function () {
                calculateQBPay();
            });
            $('#ctl00_ContentPlaceHolder1_txtDailyBonusForMonth').blur(function () {
                calculateQBPay();
            });
            $('#ctl00_ContentPlaceHolder1_txtDailyBonusForMonth').blur(function () {
                calculateQBPay();
            });
            $('#ctl00_ContentPlaceHolder1_txtMonthlyOfficeRent').blur(function () {
                calculateQBPay();
            });
