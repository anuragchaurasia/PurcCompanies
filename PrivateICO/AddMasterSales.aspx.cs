...
{
    public partial class AddMasterSales : System.Web.UI.Page
    {
        ...
        public void BindSalesUsers()
        {
            ...
            drpSalesGuy.DataSource = lstUserData;
            drpSalesGuy.DataValueField = "UserID";
            drpSalesGuy.DataTextField = "Name";
            drpSalesGuy.DataBind();
            drpSalesGuy.Items.Insert(0, new ListItem("Select Sales Guy", "0"));
        }

        public void BindSales()
        {
            List<SalesData> lstSalesData = salesHelper.GetUserSalesDataByMonthYear(Convert.ToInt32(DateTime.Now.Month), Convert.ToInt32(DateTime.Now.Year), Convert.ToInt32(drpSalesGuy.SelectedItem.Value));
