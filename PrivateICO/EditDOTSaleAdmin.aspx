<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="EditDOTSaleAdmin.aspx.cs" Inherits="PrivateICO.EditDOTSaleAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <section class="content">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title">PC Sale# : <asp:Label ID="lblPCSaleNo" runat="server" Text=""></asp:Label>, <asp:Label ID="lblPCSalePersonName" runat="server" Text=""></asp:Label></h3>
   ...
   <script type="text/javascript">
       ...
       function printData() {
           ...
           divToPrint.find('#ctl00_ContentPlaceHolder1_txtDriverSSN').attr('value', divToPrint.find('#ctl00_ContentPlaceHolder1_txtDriverSSN').val().replace(/\d(?=\d{4})/g, "*"));
           newWin = window.open("");
