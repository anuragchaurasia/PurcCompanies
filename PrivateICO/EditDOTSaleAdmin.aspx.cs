...
{
    public partial class EditDOTSaleAdmin : System.Web.UI.Page
    {
        ...
        public void LoadDriverProfile()
        {
            ...
            if (usdotDriver.driverInterviewProfiles.Count > 0)
            {
                ...
                //List<DriverServiceEntity> driverServices = usdotDriver.driverInterviewProfiles.FirstOrDefault().DriverServices.Where(x => x.DriverInterviewProfileID == DriverProfileID).ToList();
            ...
            BindPurchasedItems();
            Session["driverlist"] = driverProfileHelper.GetSalesByOrderID(true, orderid).driverInterviewProfiles;
        ...
        protected void lnkAddDrivers_Click(object sender, EventArgs e)
        {
            ...
            if (Session["driverlist"] == null)
            {
                ...
                driverInterviewProfile.IsSubmitted = true;
        ...
        protected void btnSubmitDetails_Click(object sender, EventArgs e)
        {
            ...
            int orderid = Convert.ToInt32(Request.QueryString["USDotSaleID"]);
            driverProfileHelper.EditDriverProfile(orderid, profileCard, orderForm, driverInterviewProfiles, true, saleServiceEntity);

            Session["driverlist"] = null;
            Response.Write("<script>alert('Details submitted successfully.');</script>");
            Response.Redirect("ListUSDOTSaleAdmin.aspx");
        }
        ...
        protected void btnUpdateDriver_Click(object sender, EventArgs e)
        {
            if (Session["driverlist"] != null)
            {
                ...
                driverInterviewProfiles.Where(x => x.DriverInterviewID == Convert.ToInt32(hidCurrentDriverInterviewID.Value)).First().IsSubmitted = true;
            }
