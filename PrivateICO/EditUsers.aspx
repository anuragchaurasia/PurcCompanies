<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="EditUsers.aspx.cs" Inherits="PrivateICO.EditUsers" %>
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label></label>
                                <div class="form-group">
                                    <asp:Button runat="server" ID="btnEditCustomer" Text="Edit Customers" CssClass="btn btn-block btn-success" OnClick="btnEditCustomer_Click" />
                                </div>
                            </div>
                        </div>
                        <!-- /.row -->
