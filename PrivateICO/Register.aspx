<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="PrivateICO.Register" %>
...
<head id="Head1" runat="server">
    ...
    <title>Online Discussion Portal</title>
    <!-- Font Awesome -->
                        ...
                        <div class="col-lg-6 col-lg-offset-3 ">
                            <div class="box box-info">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Online Discussion Registration</h3>
                                </div>
                                <!-- /.box-header -->
