<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="RegisterSalesMan.aspx.cs" Inherits="PrivateICO.RegisterSalesMan" %>
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label></label>
                                <div class="form-group">
                                    <asp:Button runat="server" ID="btnAddUsers" Text="Add User" OnClick="btnAddUsers_Click" CssClass="btn btn-block btn-success" />
                                </div>
                            </div>
                        </div>
                        <!-- /.row -->
